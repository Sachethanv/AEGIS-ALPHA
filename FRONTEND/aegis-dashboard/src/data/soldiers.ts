...
export const INITIAL_SOLDIERS: Soldier[] = [
  ...
  {
    id: 'ALPHA-02', name: 'Shreyas M.', rank: 'CPL', unit: 'Alpha Squad',
    bpm: 85, bpmHistory: [80,82,83,85,86,84,85,87,85,84,83,85,86,85,84,83,85,86,85,85],
    lat: 12.9726, lng: 77.5956, status: 'NOMINAL', isRealDevice: false, lastUpdated: '2s ago', spo2: 97,
  },
  {
    ...
    lat: 12.9706, lng: 77.5936, status: 'NOMINAL', isRealDevice: false, lastUpdated: '3s ago', spo2: 96,
  },
  {
    ...
    lat: 12.9736, lng: 77.5966, status: 'ELEVATED', isRealDevice: false, lastUpdated: '1s ago', spo2: 95,
  },
  {
    ...
    lat: 12.9746, lng: 77.5976, status: 'WOUNDED', isRealDevice: false, lastUpdated: 'NOW', spo2: 91,
  },
  {
    ...
    lat: 12.9756, lng: 77.5986, status: 'NOMINAL', isRealDevice: false, lastUpdated: '4s ago', spo2: 99,
  },
  {
    ...
    lat: 12.9696, lng: 77.5926, status: 'NOMINAL', isRealDevice: false, lastUpdated: '2s ago', spo2: 98,
  },
  {
    ...
    lat: 12.9766, lng: 77.5996, status: 'CRITICAL', isRealDevice: false, lastUpdated: '1s ago', spo2: 93,
  },
  {
    ...
    lat: 12.9686, lng: 77.5916, status: 'NOMINAL', isRealDevice: false, lastUpdated: '3s ago', spo2: 97,
  },
  {
    ...
    lat: 12.9776, lng: 77.6006, status: 'NOMINAL', isRealDevice: false, lastUpdated: '2s ago', spo2: 96,
  },
  {
    ...
    lat: 12.9786, lng: 77.6016, status: 'WOUNDED', isRealDevice: false, lastUpdated: 'NOW', spo2: 88,
  },
];
